...
<script src="<?= base_url();?>assets/backend/vendors/js/forms/icheck/icheck.min.js"></script>
<script src="<?= base_url();?>assets/backend/js/scripts/forms/checkbox-radio.min.js"></script>
<script src="<?= base_url();?>assets/backend/vendors/js/charts/echarts/echarts.js"></script>

<script src="<?= base_url() ?>assets/map/jquery.addressPickerByGiro.js"></script>
